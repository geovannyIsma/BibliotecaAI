  ...
  return (
    ...
    >
      ...
      <div className="relative h-72 bg-amber-50 transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Efecto de brillo en el borde (como si fuera una cubierta plastificada) */}
      ...
      >
        <div>
          ...
          {book.sinopsis && (
            <div className="mt-2 text-xs text-gray-700 bg-amber-100/80 p-2 rounded border-l-4 border-amber-300 max-h-28 overflow-y-auto custom-scrollbar">
              {book.sinopsis}
            </div>
          )}
        </div>
